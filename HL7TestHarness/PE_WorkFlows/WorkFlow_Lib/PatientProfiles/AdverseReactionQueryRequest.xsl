...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:include href="../Common/SimulatorMessages/Adverse Reaction Message Templates.xsl"/>
    ...
    <xsl:template match="/" mode="message">
        ...
        <xsl:call-template name="adverseReactionQueryRequest">
            ...
            <xsl:with-param name="reactionPeriodStartDate" select="$reactionPeriodStartDate"/>
            <xsl:with-param name="reactionPeriodEndDate" select="$reactionPeriodEndDate"/>
