...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:include href="../Common/SimulatorMessages/Prescription Message Templates.xsl"/>
    ...
    <xsl:template match="/" mode="message">
        ...
        <xsl:call-template name="RxAbortDispensingAcceptedResponse">
            ...
            <xsl:with-param name="prescription-description" select="$prescription-description"/>
