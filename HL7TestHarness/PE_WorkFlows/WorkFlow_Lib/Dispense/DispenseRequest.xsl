...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" version="1.0">
    ...
    <xsl:include href="../Common/SimulatorMessages/Dispense Message Templates.xsl"/>
    ...
    <xsl:template match="/" mode="message">
        ...
        <xsl:call-template name="DispenseRequest">
            ...
            <xsl:with-param name="fill-code" select="$fill-code"/>
