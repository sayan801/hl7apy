...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/" mode="message">
        ...
        <xsl:call-template name="invoiceRequest">
            ...
            <xsl:with-param name="invoice-description" select="$invoice-description"/>
            ...
            <xsl:with-param name="prescriber-description" select="$prescriber-description"/>
        </xsl:call-template>
    </xsl:template>
